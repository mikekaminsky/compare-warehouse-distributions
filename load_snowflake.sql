drop table if exists public.call_center;
drop table if exists public.catalog_page;
drop table if exists public.catalog_returns;
drop table if exists public.catalog_sales ;
...
drop table if exists public.household_demographics ;
drop table if exists public.income_band;
drop table if exists public.inventory ;
drop table if exists public.item ;
drop table if exists public.promotion ;
drop table if exists public.reason;
drop table if exists public.ship_mode;
drop table if exists public.store_returns ;
drop table if exists public.store_sales ;
drop table if exists public.store ;
drop table if exists public.time_dim ;
drop table if exists public.warehouse;
drop table if exists public.web_page;
drop table if exists public.web_returns ;
drop table if exists public.web_sales ;
...
copy into public.call_center from 's3://fivetran-benchmark/tpcds_100_dat/call_center/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.catalog_page from 's3://fivetran-benchmark/tpcds_100_dat/catalog_page/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.catalog_returns from 's3://fivetran-benchmark/tpcds_100_dat/catalog_returns/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.catalog_sales from 's3://fivetran-benchmark/tpcds_100_dat/catalog_sales/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.customer from 's3://fivetran-benchmark/tpcds_100_dat/customer/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.customer_address from 's3://fivetran-benchmark/tpcds_100_dat/customer_address/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.customer_demographics from 's3://fivetran-benchmark/tpcds_100_dat/customer_demographics/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.date_dim from 's3://fivetran-benchmark/tpcds_100_dat/date_dim/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.household_demographics from 's3://fivetran-benchmark/tpcds_100_dat/household_demographics/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.income_band from 's3://fivetran-benchmark/tpcds_100_dat/income_band/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.inventory from 's3://fivetran-benchmark/tpcds_100_dat/inventory/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.item from 's3://fivetran-benchmark/tpcds_100_dat/item/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.promotion from 's3://fivetran-benchmark/tpcds_100_dat/promotion/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.reason from 's3://fivetran-benchmark/tpcds_100_dat/reason/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.ship_mode from 's3://fivetran-benchmark/tpcds_100_dat/ship_mode/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.store from 's3://fivetran-benchmark/tpcds_100_dat/store/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.store_returns from 's3://fivetran-benchmark/tpcds_100_dat/store_returns/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.store_sales from 's3://fivetran-benchmark/tpcds_100_dat/store_sales/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.time_dim from 's3://fivetran-benchmark/tpcds_100_dat/time_dim/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.warehouse from 's3://fivetran-benchmark/tpcds_100_dat/warehouse/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.web_page from 's3://fivetran-benchmark/tpcds_100_dat/web_page/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.web_returns from 's3://fivetran-benchmark/tpcds_100_dat/web_returns/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.web_sales from 's3://fivetran-benchmark/tpcds_100_dat/web_sales/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
copy into public.web_site from 's3://fivetran-benchmark/tpcds_100_dat/web_site/' file_format = (type = csv field_delimiter='|' error_on_column_count_mismatch=false VALIDATE_UTF8=false );
